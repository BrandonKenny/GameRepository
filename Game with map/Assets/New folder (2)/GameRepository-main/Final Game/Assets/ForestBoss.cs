...
public class ForestBoss : MonoBehaviour
{
    ...
    public int forestBossHealth = 30;
    ...
    void Update()
    {
        ...
        {
            StartCoroutine(ForestBossfight());
